...
| Light Gray 02 | `#D7DCE2` | `215, 220, 225` | `210° 18% 87%`  | ![Light Gray 02 Color](https://via.placeholder.com/20/D7DCE2?text=+) |
...
| Headings                                    | `#BAE67E` | `186, 230, 126` | `79° 66% 70%`   | ![Headings Color](https://via.placeholder.com/20/BAE67E?text=+)        |
...
| ------------------------------------- | --------- | --------------- | --------------- | --------------------------------------------------------------------- |
| Background                            | `#000000` | `0, 0, 0`       | `0° 0% 0%`      | ![Background Color](https://via.placeholder.com/20/000000?text=+)     |
| Foreground & Text                     | `#FFD580` | `255, 213, 128` | `42° 100% 75%`  | ![Foreground Color](https://via.placeholder.com/20/FFD580?text=+)     |
| Accent, Cursor, & Bold/Underline Text | `#FF8040` | `255, 128, 64`  | `20° 100% 63%`  | ![Accent Color](https://via.placeholder.com/20/FF8040?text=+)         |
| Links                                 | `#4164FF` | `65, 100, 255`  | `227° 100% 63%` | ![Links Color](https://via.placeholder.com/20/4164FF?text=+)          |
| Selection                             | `#575757` | `87, 87, 87`    | `0° 0% 34%`     | ![Selection Color](https://via.placeholder.com/20/575757?text=+)      |
| ANSI Black (Normal)                   | `#1A1A1A` | `26, 26, 26`    | `0° 0% 10%`     | ![Black Normal Color](https://via.placeholder.com/20/1A1A1A?text=+)   |
| ANSI Black (Bright)                   | `#292929` | `41, 41, 41`    | `0° 0% 16%`     | ![Black Bright Color](https://via.placeholder.com/20/292929?text=+)   |
| ANSI Red (Normal)                     | `#FF000F` | `255, 0, 15`    | `0° 100% 50%`   | ![Red Normal Color](https://via.placeholder.com/20/FF000F?text=+)     |
| ANSI Red (Bright)                     | `#EF6B73` | `239, 107, 115` | `356° 79% 68%`  | ![Red Bright Color](https://via.placeholder.com/20/EF6B73?text=+)     |
| ANSI Green (Normal)                   | `#08D220` | `8, 210, 32`    | `127° 93% 43%`  | ![Green Normal Color](https://via.placeholder.com/20/08D220?text=+)   |
| ANSI Green (Bright)                   | `#BAE67E` | `186, 230, 126` | `79° 66% 70%`   | ![Green Bright Color](https://via.placeholder.com/20/BAE67E?text=+)   |
| ANSI Yellow (Normal)                  | `#DFC200` | `223, 194, 0`   | `52° 100% 44%`  | ![Yellow Normal Color](https://via.placeholder.com/20/DFC200?text=+)  |
| ANSI Yellow (Bright)                  | `#FFD580` | `255, 213, 128` | `42° 100% 75%`  | ![Yellow Bright Color](https://via.placeholder.com/20/FFD580?text=+)  |
| ANSI Blue (Normal)                    | `#2D449B` | `45, 68, 155`   | `228° 56% 39%`  | ![Blue Normal Color](https://via.placeholder.com/20/2D449B?text=+)    |
| ANSI Blue (Bright)                    | `#4164FF` | `65, 100, 255`  | `227° 100% 63%` | ![Blue Bright Color](https://via.placeholder.com/20/4164FF?text=+)    |
| ANSI Magenta (Normal)                 | `#AA1B86` | `170, 27, 134`  | `315° 73% 39%`  | ![Magenta Normal Color](https://via.placeholder.com/20/AA1B86?text=+) |
| ANSI Magenta (Bright)                 | `#9354FF` | `147, 84, 255`  | `264° 100% 67%` | ![Magenta Bright Color](https://via.placeholder.com/20/9354FF?text=+) |
| ANSI Cyan (Normal)                    | `#007B88` | `0, 123, 136`   | `186° 100% 27%` | ![Cyan Normal Color](https://via.placeholder.com/20/007B88?text=+)    |
| ANSI Cyan (Bright)                    | `#4DBCED` | `77, 188, 237`  | `194° 79% 62%`  | ![Cyan Bright Color](https://via.placeholder.com/20/4DBCED?text=+)    |
| ANSI White (Normal)                   | `#9C9C9C` | `156, 156, 156` | `0° 0% 61%`     | ![White Normal](https://via.placeholder.com/20/9C9C9C?text=+)         |
| ANSI White (Bright)                   | `#FFFFFF` | `255, 255, 255` | `0° 0% 100%`    | ![White Bright](https://via.placeholder.com/20/FFFFFF?text=+)         |
