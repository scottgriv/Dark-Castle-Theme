...
5. [BBEdit](https://github.com/scottgriv/Dark-Castle-BBEdit)
6. [Warp](https://github.com/scottgriv/Dark-Castle-Warp)
7. [Sketch](https://github.com/scottgriv/Dark-Castle-Sketch)
8. [Wallpaper](https://github.com/scottgriv/Dark-Castle-Wallpaper)
...
| Borders, Icons, & Menu Text      | `#9C9C9C` | `156, 156, 156` | `0° 0% 61%`     | ![Selection Color](https://via.placeholder.com/20/9C9C9C?text=+)          |
...
| Foreground, Plain Text, Operators, & Symbols | `#FFD580` | `255, 213, 128` | `42° 100% 75%`  | ![Plain Text Color](https://via.placeholder.com/20/FFD580?text=+)         |
...
| Classes & Words                          | `#FF5503` | `255, 85, 3`    | `19° 100% 51%`  | ![Symbols Color](https://via.placeholder.com/20/FF5503?text=+)            |
...
| Preprocessor                     | `#007B88` | `0, 123, 136`   | `186° 100% 27%` | ![Definitions Color](https://via.placeholder.com/20/007B88?text=+)        |
| Markdown Separator               | `#2D449B` | `45, 68, 155`   | `228° 56% 39%`  | ![Markdown Separator Color](https://via.placeholder.com/20/2D449B?text=+) |
| Functions & Keywords                         | `#AA1B86` | `170, 27, 134`  | `315° 73% 39%`  | ![Keywords Color](https://via.placeholder.com/20/AA1B86?text=+)           |
